...
public loading_screen gme =null;
	public game_menu gm;



public loading_screen getInstancegame_menu(){
	if(gme== null){
		gme = new loading_screen(this);
		return gme;
	}
	else{
		return gme;
...
//		this.setScreen(new play_screen(this));
	...
	public void gotoloading_screen(){
//		game_menu gm = new game_menu(this);
		loading_screen = getInstancegame_menu();
