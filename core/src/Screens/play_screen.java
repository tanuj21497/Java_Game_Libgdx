...
//    private final Body body;
    ...
    public void initiate_touchpad(){
        ...
        touchpad.setBounds(1200, 90, 500, 500);
...
//                m1 = new missile(world);


//                for(int i=0;i<5;i++) {
//                world.setGravity(new Vector2(0, -15));
//                Vector2 startingVelocity = new Vector2(1000000 , 100000);
...
//            Vector2 startingVelocity = new Vector2(1000000 , 100000-200*t1);
            m1 = new missile(world, player.b2body.getPosition().x, player.b2body.getPosition().y);

            m1.b2body.setLinearVelocity(10000000F, (float) ((10000000)*tan(angl*3.14/180)));
            System.out.println("fix"+ angl);
//            angl=0;
            m1.b2body.setGravityScale(0.05f);
...
//            System.out.println(player.thrown_flag);
            ...
            //            Vector2 startingVelocity = new Vector2(1000000 , 100000-200*t1);
            m2 = new missile(world, player2.b2body.getPosition().x-10, player2.b2body.getPosition().y-10);

            m2.b2body.setLinearVelocity(-10000000F, (float) ((10000000)*tan(angl*3.14/180)));
            System.out.println("fix"+ angl);
//            angl=0;
            m2.b2body.setGravityScale(0.05f);
            player2.thrown_flag=1;
        ...
        if(m1!= null && abs(player2.b2body.getPosition().x - m1.b2body.getPosition().x) <=100 && abs(player2.b2body.getPosition().y - m1.b2body.getPosition().y) <=100){
            healthBar2.setValue((healthBar2.getValue())-0.4f);
            world.destroyBody(m1.b2body);
            m1.b2body.setUserData(null);
            m1.b2body = null;
            m1 = null;
//            m1.b2body.destroyFixture(m1.);
//            world.getBodies(tempbodies);
//            for(Body b: tempbodies){
//                if(BodyUtils.bodyIsBoom(b)){
//                    world.destroyBody(b);
//                }
//            }
        }
        ...
        if(m2!= null && abs(player.b2body.getPosition().x - m2.b2body.getPosition().x) <=100 && abs(player.b2body.getPosition().y - m2.b2body.getPosition().y) <=100){
            healthBar.setValue((healthBar.getValue())-0.4f);
            world.destroyBody(m2.b2body);
            m2.b2body.setUserData(null);
            m2.b2body = null;
            m2 = null;
//            m1.b2body.destroyFixture(m1.);
//            world.getBodies(tempbodies);
...
//            }
        ...
        if(healthBar2.getValue() ==0){
            game.gotovictory_menu();
        } else if (healthBar.getValue()==0) {
...
//        Vector2 startingVelocity = new Vector2(1000000 , 100000);
//        m1.b2body.setLinearVelocity(100000, 100000);
